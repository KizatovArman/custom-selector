function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) {
    var n = null,
        ...
        m = new DOMParser;
    function h(e = null) {
        // console.log(`Entered function h e is ${JSON.stringify(e)}`);
    ...
    function f(e) {
        // console.log(`Entered function f e is ${JSON.stringify(e)}`);
    ...
    function L() {
        // console.log(`Entered function L`);
        for (var e of v.children) {
            e.addEventListener("click", (e => {
                d.find(
                    (t => t.value == e.target.dataset.value)).selected = !0,
                    r.value = null, h(), E(), r.focus()
            }))
        }
    }
    function w(e) {
        // console.log(`Entered function w e is ${JSON.stringify(e)}`);
        for (var t of o.children)
            if (!t.classList.contains("input-body") && t.firstChild.dataset.value == e) return !0; return !1
    }
    function g(e) {
        // console.log(`Entered function g e is ${JSON.stringify(e)}`);
        for (var t of o.children)
            t.classList.contains("input-body") || t.firstChild.dataset.value != e || o.removeChild(t)
    }
    function E() {
        // console.log(`Entered function E`);
        for (var e = 0; e < d.length; e++) {
            n.options[e].selected = d[e].selected;
        }
        selectMultipleTypes(JSON.stringify(d.filter(x => x.selected == true).map(x => x.value)));
        // console.log(JSON.stringify(d.filter(x => x.selected == true)));
    }
    let select_all_btn = document.getElementById("select_all_options");
    ...
    n = document.getElementById(e),
        ...
        u.addEventListener("click", (() => { p.classList.contains("hidden") && (h(), L(), p.classList.remove("hidden"), r.focus()) })),
